...
public class TextFieldAutoCompletion {
    ...
    public static class MetaData {
        ...
        /**
         * <i>({@linkplain Nullable})</i> consumer used to hook additional <i>onKeyPressed</i> back to the field without overriding the library's one.
         */
        ...
        /**
         * Gets the <i>({@linkplain Nullable})</i> consumer used to hook additional <b>onKeyPressed</b> back to the field without overriding the library's one.
         * @return The <i>({@linkplain Nullable})</i> consumer used to hook additional <b>onKeyPressed</b> back to the field without overriding the library's one.
         */
        ...
        /**
         * Sets the <i>({@linkplain Nullable})</i> consumer used to hook additional <b>onKeyPressed</b> back to the field without overriding the library's one.
