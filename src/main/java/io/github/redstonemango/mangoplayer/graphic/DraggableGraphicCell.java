...
public class DraggableGraphicCell<T> extends ListCell<T> {
    ...
    /**
     * Override for {@link Cell#updateItem(Object, boolean)}. This implementation calls the {@link #graphicFunction} and sets the cell's graphic to its {@linkplain GraphicData#graphic graphic}
     ...
     * <ul>
     *     <li><u>Graphic:</u><br>The main graphic to be displayed. This is the Node that will be shown by the {@link DraggableGraphicCell} and has to be present inside every instance of this class.</li>
     *     <li><u>Drag Source:</u><br>The node to start the drag and drop process. If this value is present, a graphic can only be dragged when the pressed element is equal to this value. If the value is not present, the graphic can be dragged always, no matter where it was pressed.</li>
     * </ul>
    ...
    public static class GraphicData {
        /**
         * The main graphic to be displayed. This is the Node that will be shown by the {@link DraggableGraphicCell} and has to be present inside every instance of this class.
         */
        private final @NotNull Node graphic;
        /**
         * The node to start the drag and drop process. If this value is present, a graphic can only be dragged when the pressed element is equal to this value. If the value is not present, the graphic can be dragged always, no matter where it was pressed.<br>
         ...
         * @param graphic The graphic to be displayed by the cell.
         ...
         * <ul>
         *     <li>If {@link #dragSource} is not present, this method will return whether the given node is part of the graphic itself <i>(intersects with it)</i></li>
